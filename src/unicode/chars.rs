...
pub fn is_identifier_start(value: u16) -> bool {
  return (ch(value) >= 'A' && ch(value) <= 'Z')
    ...
    || (value >= 0x02E0 && value <= 0x02E4)
    || value == 0x02EC
    || value == 0x02EE
    || (value >= 0x0370 && value <= 0x0374)
    || value == 0x0376
    || value == 0x0377
    || (value >= 0x037A && value <= 0x037D)
    || value == 0x037F
    || value == 0x0386
    || (value >= 0x0388 && value <= 0x038A)
    || value == 0x038C
    || (value >= 0x038E && value <= 0x03A1)
    || (value >= 0x03A3 && value <= 0x03F5)
    || (value >= 0x03F7 && value <= 0x0481)
    || (value >= 0x048A && value <= 0x052F)
    || (value >= 0x0531 && value <= 0x0556)
    || value == 0x0559
    || (value >= 0x0560 && value <= 0x0588)
    || (value >= 0x05D0 && value <= 0x05EA)
    || (value >= 0x05EF && value <= 0x05F2)
    || (value >= 0x0620 && value <= 0x064A)
    || value == 0x066E
    || value == 0x066F
    ...
    || value == 0x06EE
    || value == 0x06EF
    || (value >= 0x06FA && value <= 0x06FC)
    || value == 0x06FF
    || value == 0x0710
    || (value >= 0x0712 && value <= 0x072F)
    || (value >= 0x074D && value <= 0x07A5)
    || value == 0x07B1
    || (value >= 0x07CA && value <= 0x07EA)
    || value == 0x07F4
    || value == 0x07F5
    || value == 0x07FA
    || (value >= 0x0800 && value <= 0x0815)
    || value == 0x081A
    || value == 0x0824
    || value == 0x0828
    ...
    || (value >= 0x0904 && value <= 0x0939)
    || value == 0x093D
    || value == 0x0950
    || (value >= 0x0958 && value <= 0x0961)
    || (value >= 0x0971 && value <= 0x0980)
    || (value >= 0x0985 && value <= 0x098C)
    || value == 0x098F
    || value == 0x0990
    || (value >= 0x0993 && value <= 0x09A8)
    || (value >= 0x09AA && value <= 0x09B0)
    || value == 0x09B2
    || (value >= 0x09B6 && value <= 0x09B9)
    || value == 0x09BD
    || value == 0x09CE
    || value == 0x09DC
    || value == 0x09DD
    || (value >= 0x09DF && value <= 0x09E1)
    || value == 0x09F0
    || value == 0x09F1
    || value == 0x09FC
    || (value >= 0x0A05 && value <= 0x0A0A)
    || value == 0x0A0F
    || value == 0x0A10
    || (value >= 0x0A13 && value <= 0x0A28)
    || (value >= 0x0A2A && value <= 0x0A30)
    || value == 0x0A32
    || value == 0x0A33
    || value == 0x0A35
    || value == 0x0A36
    || value == 0x0A38
    || value == 0x0A39
    || (value >= 0x0A59 && value <= 0x0A5C)
    || value == 0x0A5E
    || (value >= 0x0A72 && value <= 0x0A74)
    || (value >= 0x0A85 && value <= 0x0A8D)
    || (value >= 0x0A8F && value <= 0x0A91)
    || (value >= 0x0A93 && value <= 0x0AA8)
    || (value >= 0x0AAA && value <= 0x0AB0)
    || value == 0x0AB2
    || value == 0x0AB3
    || (value >= 0x0AB5 && value <= 0x0AB9)
    || value == 0x0ABD
    || value == 0x0AD0
    || value == 0x0AE0
    || value == 0x0AE1
    || value == 0x0AF9
    || (value >= 0x0B05 && value <= 0x0B0C)
    || value == 0x0B0F
    || value == 0x0B10
    || (value >= 0x0B13 && value <= 0x0B28)
    || (value >= 0x0B2A && value <= 0x0B30)
    || value == 0x0B32
    || value == 0x0B33
    || (value >= 0x0B35 && value <= 0x0B39)
    || value == 0x0B3D
    || value == 0x0B5C
    || value == 0x0B5D
    || (value >= 0x0B5F && value <= 0x0B61)
    || value == 0x0B71
    || value == 0x0B83
    || (value >= 0x0B85 && value <= 0x0B8A)
    || (value >= 0x0B8E && value <= 0x0B90)
    || (value >= 0x0B92 && value <= 0x0B95)
    || value == 0x0B99
    || value == 0x0B9A
    || value == 0x0B9C
    || value == 0x0B9E
    ...
    || (value >= 0x0BAE && value <= 0x0BB9)
    || value == 0x0BD0
    || (value >= 0x0C05 && value <= 0x0C0C)
    || (value >= 0x0C0E && value <= 0x0C10)
    || (value >= 0x0C12 && value <= 0x0C28)
    || (value >= 0x0C2A && value <= 0x0C39)
    || value == 0x0C3D
    || (value >= 0x0C58 && value <= 0x0C5A)
    || value == 0x0C60
    || value == 0x0C61
    || value == 0x0C80
    ...
    || (value >= 0x0D12 && value <= 0x0D3A)
    || value == 0x0D3D
    || value == 0x0D4E
    || (value >= 0x0D54 && value <= 0x0D56)
    || (value >= 0x0D5F && value <= 0x0D61)
    || (value >= 0x0D7A && value <= 0x0D7F)
    || (value >= 0x0D85 && value <= 0x0D96)
    || (value >= 0x0D9A && value <= 0x0DB1)
    || (value >= 0x0DB3 && value <= 0x0DBB)
    || value == 0x0DBD
    || (value >= 0x0DC0 && value <= 0x0DC6)
    || (value >= 0x0E01 && value <= 0x0E30)
    || value == 0x0E32
    || value == 0x0E33
    || (value >= 0x0E40 && value <= 0x0E46)
    || value == 0x0E81
    || value == 0x0E82
    || value == 0x0E84
    || (value >= 0x0E86 && value <= 0x0E8A)
    || (value >= 0x0E8C && value <= 0x0EA3)
    || value == 0x0EA5
    || (value >= 0x0EA7 && value <= 0x0EB0)
    || value == 0x0EB2
    || value == 0x0EB3
    || value == 0x0EBD
    || (value >= 0x0EC0 && value <= 0x0EC4)
    || value == 0x0EC6
    || (value >= 0x0EDC && value <= 0x0EDF)
    || value == 0x0F00
    || (value >= 0x0F40 && value <= 0x0F47)
    || (value >= 0x0F49 && value <= 0x0F6C)
    || (value >= 0x0F88 && value <= 0x0F8C)
    || (value >= 0x1000 && value <= 0x102A)
    || value == 0x103F
    || (value >= 0x1050 && value <= 0x1055)
    || (value >= 0x105A && value <= 0x105D)
    || value == 0x1061
    || value == 0x1065
    || value == 0x1066
    || (value >= 0x106E && value <= 0x1070)
    || (value >= 0x1075 && value <= 0x1081)
    || value == 0x108E
    || (value >= 0x10A0 && value <= 0x10C5)
    || value == 0x10C7
    || value == 0x10CD
    || (value >= 0x10D0 && value <= 0x10FA)
    || (value >= 0x10FC && value <= 0x1248)
    || (value >= 0x124A && value <= 0x124D)
    || (value >= 0x1250 && value <= 0x1256)
    || value == 0x1258
    ...
    || (value >= 0x1780 && value <= 0x17B3)
    || value == 0x17D7
    || value == 0x17DC
    || (value >= 0x1820 && value <= 0x1878)
    || (value >= 0x1880 && value <= 0x18A8)
    || value == 0x18AA
    ...
    || (value >= 0x1A20 && value <= 0x1A54)
    || value == 0x1AA7
    || (value >= 0x1B05 && value <= 0x1B33)
    || (value >= 0x1B45 && value <= 0x1B4B)
    || (value >= 0x1B83 && value <= 0x1BA0)
    || value == 0x1BAE
    || value == 0x1BAF
    || (value >= 0x1BBA && value <= 0x1BE5)
    ...
    || (value >= 0x1F50 && value <= 0x1F57)
    || value == 0x1F59
    || value == 0x1F5B
    || value == 0x1F5D
    || (value >= 0x1F5F && value <= 0x1F7D)
    || (value >= 0x1F80 && value <= 0x1FB4)
    || (value >= 0x1FB6 && value <= 0x1FBC)
    || value == 0x1FBE
    ...
    || (value >= 0x1FF6 && value <= 0x1FFC)
    || value == 0x2071
    || value == 0x207F
    || (value >= 0x2090 && value <= 0x209C)
    || value == 0x2102
    || value == 0x2107
    || (value >= 0x210A && value <= 0x2113)
    || value == 0x2115
    || (value >= 0x2118 && value <= 0x211D)
    || value == 0x2124
    || value == 0x2126
    || value == 0x2128
    || (value >= 0x212A && value <= 0x2139)
    || (value >= 0x213C && value <= 0x213F)
    || (value >= 0x2145 && value <= 0x2149)
    || value == 0x214E
    || (value >= 0x2160 && value <= 0x2188)
    || (value >= 0x2C00 && value <= 0x2C2E)
    || (value >= 0x2C30 && value <= 0x2C5E)
    || (value >= 0x2C60 && value <= 0x2CE4)
    || (value >= 0x2CEB && value <= 0x2CEE)
    || value == 0x2CF2
    || value == 0x2CF3
    || (value >= 0x2D00 && value <= 0x2D25)
    || value == 0x2D27
    || value == 0x2D2D
    || (value >= 0x2D30 && value <= 0x2D67)
    || value == 0x2D6F
    ...
    || (value >= 0xA610 && value <= 0xA61F)
    || value == 0xA62A
    || value == 0xA62B
    || (value >= 0xA640 && value <= 0xA66E)
    ...
    || (value >= 0xAA60 && value <= 0xAA76)
    || value == 0xAA7A
    || (value >= 0xAA7E && value <= 0xAAAF)
    || value == 0xAAB1
    || value == 0xAAB5
    || value == 0xAAB6
    || (value >= 0xAAB9 && value <= 0xAABD)
    || value == 0xAAC0
    || value == 0xAAC2
    || (value >= 0xAADB && value <= 0xAADD)
    ...
    || (value >= 0xFB13 && value <= 0xFB17)
    || value == 0xFB1D
    || (value >= 0xFB1F && value <= 0xFB28)
    || (value >= 0xFB2A && value <= 0xFB36)
    || (value >= 0xFB38 && value <= 0xFB3C)
    || value == 0xFB3E
    || value == 0xFB40
    || value == 0xFB41
    || value == 0xFB43
    || value == 0xFB44
    || (value >= 0xFB46 && value <= 0xFBB1)
    ...
    || (value >= 0x0002F800 && value <= 0x0002FA1D)
    || value == 0x0149
    || ch(value) == '_'
    || ch(value) == '$'
    || value == 92;
...
// http://www.ecma-international.org/ecma-262/9.0/index.html#sec-names-and-keywords
pub fn is_identifier_continue(value: u16, is_unicode_escape_seq: bool) -> bool {
  return is_identifier_start(value)
    ...
    || (value >= 0x09BC && value <= 0x09C4)
    || value == 0x09C7
    || value == 0x09C8
    || (value >= 0x09CB && value <= 0x09CE)
    || value == 0x09D7
    || (value >= 0x09DF && value <= 0x09E3)
    || (value >= 0x09E6 && value <= 0x09F1)
    || value == 0x09FE
    || (value >= 0x0A01 && value <= 0x0A03)
    || value == 0x0A3C
    || (value >= 0x0A3E && value <= 0x0A42)
    || value == 0x0A47
    || value == 0x0A48
    || (value >= 0x0A4B && value <= 0x0A4D)
    || value == 0x0A51
    || (value >= 0x0A66 && value <= 0x0A75)
    ...
    || (value >= 0x0D66 && value <= 0x0D6F)
    || value == 0x0D82
    || value == 0x0D83
    || value == 0x0DCA
    || (value >= 0x0DCF && value <= 0x0DD4)
    || value == 0x0DD6
    || (value >= 0x0DD8 && value <= 0x0DDF)
    || (value >= 0x0DE6 && value <= 0x0DEF)
    || value == 0x0DF2
    || value == 0x0DF3
    || (value >= 0x0E01 && value <= 0x0E3A)
    || (value >= 0x0E40 && value <= 0x0E4E)
    || (value >= 0x0E50 && value <= 0x0E59)
    || (value >= 0x0EA7 && value <= 0x0EBD)
    || (value >= 0x0EC8 && value <= 0x0ECD)
    || (value >= 0x0ED0 && value <= 0x0ED9)
    || value == 0x0F18
    || value == 0x0F19
    || (value >= 0x0F20 && value <= 0x0F29)
    || value == 0x0F35
    || value == 0x0F37
    || value == 0x0F39
    ...
    || (value >= 0x1740 && value <= 0x1753)
    || value == 0x1772
    || value == 0x1773
    || (value >= 0x1780 && value <= 0x17D3)
    || value == 0x17DD
    || (value >= 0x17E0 && value <= 0x17E9)
    ...
    || (value >= 0x1DFB && value <= 0x1F15)
    || value == 0x203F
    || value == 0x2040
    || value == 0x2054
    || (value >= 0x20D0 && value <= 0x20DC)
    || value == 0x20E1
    ...
    || (value >= 0xAB70 && value <= 0xABEA)
    || value == 0xABEC
    || value == 0xABED
    || (value >= 0xABF0 && value <= 0xABF9)
    || (value >= 0xFB1D && value <= 0xFB28)
    || (value >= 0xFE00 && value <= 0xFE0F)
    || (value >= 0xFE20 && value <= 0xFE2F)
    || value == 0xFE33
    || value == 0xFE34
    || (value >= 0xFE4D && value <= 0xFE4F)
    ...
    || (is_unicode_escape_seq && is_hex_digits(value));
}
