...
token_enum! {
  Token {
    ...
    (Comment,              true,  false, false, "$Comment"),
    ...
    (Identifier,           true,  true, false, "$Identifier"),
    (RegExpFlag,           true,  true, false, "$RegExpFlag"),
    (NumericLiteral,       true,  true, false, "$NumericLiteral"),
